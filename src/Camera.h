#ifndef HEADER_64454DD38F9ACBBA
#define HEADER_64454DD38F9ACBBA
...
namespace tdogl {
    ...
    public:
        ...
        void setHorizontalAngle( float angle ) { _horizontalAngle = angle; };
        float getHorizontalAngle( ) { return _horizontalAngle; };

        void setVerticalAngle( float angle ) { _verticalAngle = angle; };
        float getVerticalAngle( ) { return _verticalAngle; };
